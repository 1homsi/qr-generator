    ...
    <div className="customization-wrapper">
      ...
      <div className="customization-group">
        <button
          ...
          aria-expanded={open.frame}
        >
          <h4>Frame Style</h4>
          <FiChevronDown
            className={`accordion-chevron ${open.frame ? "open" : ""}`}
          />
        </button>
        <div className={`accordion-body ${open.frame ? "open" : ""}`}>
      ...
      <div className="customization-group">
        <button
          ...
          aria-expanded={open.corners}
        >
          <h4>Corner Dots</h4>
          <FiChevronDown
            className={`accordion-chevron ${open.corners ? "open" : ""}`}
          />
        </button>
        <div className={`accordion-body ${open.corners ? "open" : ""}`}>
          <div className="accordion-inner">
            <div>
              <div className="qr-types">
      ...
      <div className="customization-group">
        ...
        >
          <h4>Dot Pattern</h4>
          <FiChevronDown
            className={`accordion-chevron ${open.dots ? "open" : ""}`}
          />
        </button>
        <div className={`accordion-body ${open.dots ? "open" : ""}`}>
          <div className="accordion-inner">
            <div>
      ...
      <div className="customization-group">
        ...
        >
          ...
          <FiChevronDown
            className={`accordion-chevron ${open.colors ? "open" : ""}`}
          />
        </button>
        <div className={`accordion-body ${open.colors ? "open" : ""}`}>
          <div className="accordion-inner">
            <div>
      ...
      <div className="customization-group">
        ...
        >
          <h4>Logo</h4>
          <FiChevronDown
            className={`accordion-chevron ${open.logo ? "open" : ""}`}
          />
        </button>
        <div className={`accordion-body ${open.logo ? "open" : ""}`}>
          <div className="accordion-inner">
            <div>
